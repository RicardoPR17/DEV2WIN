...
class UpvoteTest {
    ...
    void shouldSetUpvoteId(Long input) {
        ...
        Initiative initiative = new Initiative("test idea", State.OPEN, "a", "b", "c", user, Area.ANIMALS);
    ...
    void shouldSetUser() {
        User user = new User("Equis", "abc", Role.PROPONENTE, "", Profile.ESTUDIANTE, "x@escuelaing.edu.co");
        Initiative initiative = new Initiative("test idea", State.OPEN, "a", "b", "c", user, Area.IA);
        Upvote upvote = new Upvote(initiative, user);
    ...
    void shouldGiveUser() {
        User user = new User("Equis", "abc", Role.PROPONENTE, "", Profile.ESTUDIANTE, "x@escuelaing.edu.co");
        Initiative initiative = new Initiative("test idea", State.OPEN, "a", "b", "c", user, Area.ENVIRONMENT);
        Upvote upvote = new Upvote(initiative, user);
    ...
    void shouldSetInitiative() {
        User user = new User("Equis", "abc", Role.PROPONENTE, "", Profile.ESTUDIANTE, "x@escuelaing.edu.co");
        Initiative initiative = new Initiative("test idea", State.OPEN, "a", "b", "c", user, Area.HEALTHY);
        Upvote upvote = new Upvote(initiative, user);
        Initiative anotherInitiative = new Initiative("another project", State.REVIEW, "d", "e", "f", user, Area.IA);
    ...
    void shouldGiveInitiative() {
        User user = new User("Equis", "abc", Role.PROPONENTE, "", Profile.ESTUDIANTE, "x@escuelaing.edu.co");
        Initiative initiative = new Initiative("test idea", State.OPEN, "a", "b", "c", user, Area.UNDERTAKING);
        Upvote upvote = new Upvote(initiative, user);
